...
<embed src="myflash.fla" type="application/x-shockwave-flash" width="300" height="400" allowScriptAccess="always" allowFullScreen="true"></embed>
    ...
    $expected = '<iframe src="http://www.youtube.com/embed/_9tHtxOCvy4" frameborder="0" webkitAllowFullScreen="true" mozAllowFullScreen="true" allowFullScreen="true" width="100%" height="100%"></iframe>';
    $this->assertEquals($expected, embed::youtube('http://www.youtube.com/watch?feature=player_embedded&v=_9tHtxOCvy4'));
    
    $expected = '<iframe src="http://player.vimeo.com/video/52345557" frameborder="0" webkitAllowFullScreen="true" mozAllowFullScreen="true" allowFullScreen="true" width="100%" height="100%"></iframe>';
